...
############################################################ install MosaicViewer_CNBP
WORKDIR /home/tools/

RUN git clone https://github.com/MaestSi/MosaicViewer_CNBP.git
WORKDIR /home/tools/MosaicViewer_CNBP
RUN chmod 755 *

RUN sed -i 's/PIPELINE_DIR=.*/PIPELINE_DIR=\"\/home\/tools\/MosaicViewer_CNBP\/\"/' config_MosaicViewer.sh
